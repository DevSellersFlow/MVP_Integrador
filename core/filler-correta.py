...
MARKETPLACE_CONFIG: dict[str, dict] = {
    ...
    "Shopee": {
        ...
        "unit_conversions": {
            "peso_pacote": ("kg", "kg"),
            "comprimento_pacote": ("cm", "cm"),
            "largura_pacote": ("cm", "cm"),
            "altura_pacote": ("cm", "cm"),
        },
    },
    "Vendor": {
    ...
    "Magalu": {
        "sheet": "PRODUTO",
        "header_row": 3,  # linha 3 tem os cabeçalhos reais (SKU, EAN, TITULO_PRODUTO...)
        "data_start": 5,  # linha 5 é onde os dados começam (pula grupos, headers, descrições)
        "unit_conversions": {
            "altura_pacote":      ("cm", "m"),
            "largura_pacote":     ("cm", "m"),
